...
CREATE TABLE IF NOT EXISTS header_pages (
    ...
    link_color VARCHAR(20) DEFAULT '#3B82F6',
...
-- INSERT INTO header_pages (organization_id, user_id, organization_name, active)
-- SELECT id, created_by, name, FALSE FROM organizations WHERE id NOT IN (SELECT organization_id FROM header_pages);
