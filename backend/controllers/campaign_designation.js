...
export const createRelationBatch = asyncHandler(async (req, res) => {
  ...
  return new Promise((resolve, reject) => {
    db.query(query, [values], (err, data) => {
      ...
      sendCreated(res, { insertedCount: data.affectedRows }, 'Campaign designation relations created successfully');
      resolve();
    })
  })
})
...
export const getRelations = asyncHandler(async (req, res) => {
  ...
  return new Promise((resolve, reject) => {
    db.query(query, [id], (err, data) => {
      ...
      sendSuccess(res, data, 'Campaign designation relations retrieved successfully');
      resolve();
    })
  })
})
...
export const deleteRelation = asyncHandler(async (req, res) => {
  ...
  return new Promise((resolve, reject) => {
    db.query(query, [id], (err, data) => {
      ...
      sendDeleted(res, 'Campaign designation relation deleted successfully');
      resolve();
    })
  })
})
...
export const deleteRelationBatch = asyncHandler(async (req, res) => {
  ...
  return new Promise((resolve, reject) => {
    db.query(query, [values], (err, data) => {
      ...
      sendDeleted(res, `Deleted ${data.affectedRows} campaign designation relations successfully`);
      resolve();
    })
  })
})