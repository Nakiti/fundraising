...
import { initialHeaderPageSections } from "@/app/constants/pageSectionsConfig";
...
export const HeaderPageContextProvider = ({organizationId, children}) => {
   ...
   const [sections, setSections] = useState(initialHeaderPageSections)
   ...
   useEffect(() => {
      const fetchData = async() => {
         try {
            ...
            console.log('Header page data:', response.data.active);
