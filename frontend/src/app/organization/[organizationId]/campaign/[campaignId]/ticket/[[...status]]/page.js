   ...
   return (
      <div className="w-full mb-4 bg-white overflow-y-auto" >
         <div class="relative w-full mb-12" style={{height: "75vh"}}>
            ...
            >
               <h1 class="mb-2" style={{fontSize: "60px"}}>{"Title"}</h1>
               <h3 class="mb-2" style={{fontSize: "28px"}}>{"Date"}</h3>
               <p class="mb-8" style={{fontSize: "28px"}}>{"Address"}</p>
               <Link 
            ...
            <div className="">
               ...
               <div className="mt-16 border-t border-white">
                  <div className="flex flex-row w-1/2 mx-auto justify-between items-center">
                     <div className="">
                        <p className="text-3xl mb-6">asdadad</p>
                        <p className="text-ml">asddad</p>
                     </div>
                     <div>
                        <img 
