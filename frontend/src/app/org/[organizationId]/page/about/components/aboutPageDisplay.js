...
const AboutPageDisplay = () => {
   const {inputs, sections, isLoading} = useContext(AboutPageContext)
   ...
   const LoadingSkeleton = () => (
      <div className="bg-white animate-pulse">
         {/* Hero skeleton */}
         <div className="relative w-full bg-gray-200" style={{height: "600px"}}>
                  ...
                  <div className="max-w-4xl mx-auto">
                     <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <div className="text-left">
                           ...
                           >
                              {inputs.storyText || "We are dedicated to making a positive impact in our community through innovative solutions and unwavering commitment to our mission. Our journey began with a simple belief that together, we can create lasting change."}
                           </p>
                        </div>
                        {inputs.storyImage && (
