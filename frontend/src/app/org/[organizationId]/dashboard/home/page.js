...
import { getTransactionsOverTime, getUserData } from "@/app/services/fetchService"
   ...
   useEffect(() => {
      const fetchUser = async() => {
         try {
            ...
            console.log("asdasd", userResponse)
         } catch (err) {
            console.log(err)
         }
      }
...
<div className="w-full h-full p-4 text-gray-800">
  <div className="w-full h-full rounded-sm overflow-y-auto p-6  bg-white">
    ...
    <div className="w-5/6 mx-auto grid grid-cols-3 gap-6 mb-10">
      {[
        ...
        <div key={item.label} className="bg-gray-50 rounded-lg shadow-sm p-8 flex flex-col items-center text-center">
    ...
    <div className="bg-gray-50 rounded-lg shadow-sm w-3/4 mx-auto mb-10">
      ...
      <div className="p-6 grid grid-cols-2 gap-8 text-gray-700">
        ...
        <div>
          ...
          <div className="flex justify-between mb-3">
            ...
            <p className="px-3 py-1 text-md font-medium text-gray-700">37</p>
          </div>
        </div>
      </div>
    </div>
