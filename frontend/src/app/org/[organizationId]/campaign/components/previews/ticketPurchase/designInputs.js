            ...
            <div className="mb-6">
               ...
               <div className="relative">
                  <input 
                     ...
                     name="p_color"
                     value={ticketPurchaseInputs.p_color}
                     onChange={handleTicketPurchaseInputsChange}
                     style={{ backgroundColor: ticketPurchaseInputs.p_color }}  
                  />
                  <div 
            ...
            <div className="mb-6">
               ...
               <div className="relative">
                  <input 
                     ...
                     className="opacity-0 absolute inset-0 w-6 h-6 cursor-pointer"
                     name="s_color"
                     value={ticketPurchaseInputs.s_color}
                     onChange={handleTicketPurchaseInputsChange}
                  />
                  <div 
                     className="w-8 h-8 rounded-full border border-gray-800 cursor-pointer"
                     style={{ backgroundColor: ticketPurchaseInputs.s_color }}  
                  />
               </div>
            </div>
         </div>
            ...
            <div className="mb-6">
               ...
               <div className="relative">
                  <input 
                     ...
                     className="opacity-0 absolute inset-0 w-6 h-6 cursor-pointer"
                     name="bg_color"
                     value={ticketPurchaseInputs.bg_color}
                     onChange={handleTicketPurchaseInputsChange}
                  />
                  <div 
                     className="w-8 h-8 rounded-full border border-gray-800 cursor-pointer"
                     style={{ backgroundColor: ticketPurchaseInputs.bg_color }}  
                  />
               </div>
            </div>
         </div>
