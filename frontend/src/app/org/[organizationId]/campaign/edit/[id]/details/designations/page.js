...
const Desingations = () => {
   const {designations, campaignDetails, handleCampaignDetailsChange, campaignId, campaignStatus, selectedDesignations, setSelectedDesignations} = useContext(CampaignContext)
