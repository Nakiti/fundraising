         ...
         <div className="relative w-full">
               ...
               <div className="absolute inset-0 flex flex-col items-center justify-center text-center space-y-6 bg-black bg-opacity-50">
                  ...
                  <h1 
                     ...
                     style={{color: inputs.p_color}}
                  >
                  {inputs.title || "Title"}
               </h1>

                  <p 
                     className="text-sm text-gray-200 w-11/12 md:w-2/3 lg:w-1/2 mx-auto"
                     style={{color: inputs.s_color}}
                  >
                  ...
                  <div className="flex justify-center space-x-4">
                     <button  className="bg-blue-800 hover:bg-blue-700 text-white py-2 px-6 text-sm rounded-md transition">
                        Donate
                     </button>
                     <button className="bg-blue-800 hover:bg-blue-700 text-white py-2 px-6 text-sm rounded-md transition">
                        Share
            ...
            <div className="flex flex-col md:flex-row items-center space-x-4 justify-between w-full py-12 px-16">
               <div className="md:w-1/2 space-y-6">
                  ...
                  <button 
                     className="bg-blue-600 hover:bg-blue-700 text-white py-2 text-xs px-6 rounded-sm transition">
                     Learn More
                  </button>
               </div>
                              ...
                              <div className="px-6 py-4">
                                 <div className="flex flex-row space-x-2 justify-between items-center">
                                    ...
                                    <div className="flex flex-col items-end space-y-1">
                                       <button 
                                          className="px-2 w-16 py-1 bg-blue-600 rounded-sm text-white text-xs text-center" 
                                       >
                                          Donate
                                       </button>
                                       <button className="px-4 w-16 py-1 bg-gray-200 rounded-sm text-xs">Share</button>
                                    </div>
                                 </div>
                              </div>
                           </div>
