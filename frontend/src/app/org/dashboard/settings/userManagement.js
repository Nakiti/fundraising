...
const UserManagement = () => {
   ...
   return (
      <div>
         <h1 className="text-lg font-semibold mb-4 text-gray-800">Users</h1>
               ...
               <tbody>
                  {users && users.map((user) => (
                     <tr key={user.id} className="border-b border-gray-200 hover:bg-gray-50">
                        <td className="px-4 py-2 text-gray-700 whitespace-nowrap">{user.first_name}</td>
                        <td className="px-4 py-2 text-gray-700 whitespace-nowrap">{user.last_name}</td>
         ...
         <div className="mt-8">
            <h2 className="text-md font-semibold mb-4 text-gray-800">Add New User</h2>
            <form onSubmit={handleAddUser} className="grid grid-cols-4 gap-4 w-3/4 text-sm">
