...
const Designations = () => {
   ...
   return (
      <div>
         <h1 className="text-lg font-semibold mb-4 text-gray-800">Designations</h1>
         <div className="overflow-x-auto w-11/12">
            <table className="min-w-full bg-white text-sm">
               <thead>
                  <tr>
                     <th className="px-6 py-2 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">Title</th>
                     <th className="px-6 py-2 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">Donations</th>
                     <th className="px-6 py-2 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">Raised</th>
                     <th className="px-6 py-2 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">Goal</th>
                     <th className="px-6 py-2 border-b border-gray-300 text-left text-sm font-semibold text-gray-700">Status</th>
         ...
         <div className="mt-8">
            <h2 className="text-md font-semibold mb-4 text-gray-800">Add New Designation</h2>
